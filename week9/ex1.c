...
// This function Looks for a page with the given id in the given page table
...
// This function Finds and returns the address of the first available page frames. This address is either an empty frame i.e (id == 0) or the one with the lowest counter
...
int main(int argc, char *argv[])
{
	...
	{
		// Checking the pre-existence of this page
		page_t *page = find_page(pages, page_id, page_count);
		if(page != NULL)	// It exists!
		{
			hits++;
		}
		else				// it is a miss
